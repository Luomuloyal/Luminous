...
class _RegisterPageState extends ConsumerState<RegisterPage> {
  ...
  late final _identifierType = widget.initialIdentifierType;
  var _agreed = false;
  ...
  void initState() {
    ...
    ref
        ...
        .initCodeTarget(widget.initialIdentifier, widget.initialCode);
  }
  ...
  Future<void> _onRegisterPressed() async {
    ...
    try {
      ...
      ToastUtils.instance.show(
        context,
        e.message.isNotEmpty ? e.message : '注册失败',
      );
    }
  }
    ...
    return AuthPageScaffold(
      children: [
        ...
        AuthHeroCard(
          ...
          subtitle: l10n.registerHeroSubtitle(_identifierLabel()),
        ),
          ...
          child: Column(
            children: [
              _buildField(
                ...
                label: _l10n.registerUsernameLabel,
                hint: _l10n.registerUsernameHint,
